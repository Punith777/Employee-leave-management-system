    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title blue-gray-text text-darken-2">Manage Employes</div>
                    </div>
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="blue-gray-text text-darken-3">Emp Id</th>
                                            <th class="blue-gray-text text-darken-3">Emp Name</th>
                                            <th class="blue-gray-text text-darken-3">Department</th>
                                             <th class="blue-gray-text text-darken-3">Status</th>
                                             <th class="blue-gray-text text-darken-3">Reg Date</th>

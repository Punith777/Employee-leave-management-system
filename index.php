...
<html lang="en">
    ...
    <body>
                ...
                <nav class="navbar navbar-expand-lg navbar-light py-3 blue-gray darken-3" style="background:#546e7a !important">
                          ...
                          <div class="col-md-6 d-flex justify-content-center align-items-center">
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title blue-gray-text text-darken-2" style="font-size:20px;">Employee Login</span>

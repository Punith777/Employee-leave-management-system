...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title blue-gray-text text-darken-2">Apply for Leave</div>
                    </div>
...
<input placeholder="" id="mask1" name="fromdate" class="masked datepicker" type="text" data-inputmask="'alias': 'date'" required>
</div>
<div class="input-field col m6 s12">
<label for="todate">To Date</label>
<input placeholder="" id="mask1" name="todate" class="masked datepicker" type="text" data-inputmask="'alias': 'date'" required>
</div>
